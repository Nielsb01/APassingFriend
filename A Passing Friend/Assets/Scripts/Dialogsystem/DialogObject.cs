...
public class DialogObject
{
    ...
    private FMODUnity.EventReference _dialogAudio;
    ...
    public void SetDialogAudio(FMODUnity.EventReference dialogAudio)
    {
    ...
    public FMODUnity.EventReference GetDialogAudio()
    {
        return _dialogAudio;
    }
}